@{
    VM0 = @{                                            # VM0 is the first VM - do not change this name
        ...
        Owner         = 'myavd'                         
        adminPassword = 'some0815pwd!'                   # (optional) password for the local admin account - if not set, the generic password $adminPassword from CreateHyperVVM.ps1 will be used
